...
function f(e) {
    ...
    for (; t && t !== document.body;) {
        let e = window.getComputedStyle(t), n = e.overflowY, r = e.overflowX,
            a = /(auto|scroll)/.test(n) && t.scrollHeight > t.clientHeight,
            o = /(auto|scroll)/.test(r) && t.scrollWidth > t.clientWidth;
        if (a || o) return t;
        t = i(t);
    }
