    ...
    m(), i(), C(), y(), g(), l(), n(), k = /* @__PURE__ */ e(D(), 1), S(), h(), T(), f(), A = class extends w {
      ...
      <dl class="border-dashed divide-y m-0">
        ...
        renderRow(e) {
            ...
            let t = e.name === "IDE Plugin" && e.value === !0 && v.idePluginState?.ide ? v.idePluginState.ide : e.value,
                n = this.getIcon(e.name, t), i = this.getIconColor(e.name), a = this.getTextColor(e);
            return o`
        ...
        getIcon(e, t) {
            switch (e) {
                ...
                case "Java Hotswap":
                    return a.swapHoriz;
                case "IDE Plugin":
                    return typeof t == "string" ? t.toLowerCase() === "intellij" ? a.intelliJ : t.toLowerCase() === "vscode" ? a.vsCode : t.toLowerCase() === "eclipse" ? a.eclipse : a.developerModeTv : a.developerModeTv;
                default:
                    return null;
            }
        }
