...
import {
    ...
    t as Ie,
    u as Le
} from "./copilot-userinfo-C0s6T_kB.js";
...
var at, ot, st, ct, lt, ut = t((() => {
    ...
    de(), me(), he(), v(), tt(), Ct(), g(), ze(), ve(), ae(), re(), d(), fe(), wt = class extends pe {
      ...
      ${nt(this.openPanels, (e) => e.tag, (e) => b`<vaadin-dialog
            ...
            @resize="${(t) => {
                let {top: n, left: r, width: i, height: a} = t.detail, o = t.currentTarget, s = Number.parseFloat(i),
                    c = Number.parseFloat(a), l = this.getViewportAdjustedPosition({
    ...
    `;
        ...
        getOpenPanelContainerDialogs() {
            let e = Array.from(this.querySelectorAll("vaadin-dialog[panel-container][opened]")),
                t = E.panelStackingOrder;
            return e.sort((e, n) => {
        ...
        getViewportAdjustedPosition(e) {
            let t = this.getViewportPaddingPx(), n = Number.isFinite(e.width) ? e.width : 0,
                r = Number.isFinite(e.height) ? e.height : 0, i = Number.isFinite(e.top) ? e.top : 0,
                a = Number.isFinite(e.left) ? e.left : 0, o = a + n, s = i + r, c = 0, l = 0;
...
var It, Lt, Rt = t((() => {
    ...
    me(), v(), Ct(), g(), xe(), fe(), zt = class extends h {
      ...
      ${xt(() => b`
        ...
        sendEvent(e) {
            this.dispatchEvent(new CustomEvent("ai-usage-response", {
                detail: {
                    response: e,
    ...
    return {
        ...
        animateAll: function (n) {
            ...
            e.forEach(function (e) {
                var t = 0, n = e.target, o = n.fromRect, s = I(n), c = n.prevFromRect, l = n.prevToRect, u = e.rect,
                    d = wn(n, !0);
        ...
        animate: function (e, t, n, r) {
            if (r) {
                ...
                var i = wn(this.el), a = i && i.a, o = i && i.d, s = (t.left - n.left) / (a || 1),
                    c = (t.top - n.top) / (o || 1);
...
function Un(e) {
    var t = e.sortable, n = e.rootEl, r = e.name, i = e.targetEl, a = e.cloneEl, o = e.toEl, s = e.fromEl,
        c = e.oldIndex, l = e.newIndex, u = e.oldDraggableIndex, d = e.newDraggableIndex, f = e.originalEvent,
        p = e.putSortable, m = e.extraEventProperties;
    if (t ||= n && n[B], t) {
...
function Xn(e, t, n, r, i, a, o, s) {
    var c = r ? e.clientY : e.clientX, l = r ? n.height : n.width, u = r ? n.top : n.left, d = r ? n.bottom : n.right,
        f = !1;
    if (!o) {
        if (s && Vr < l * i) {
...
function nr() {
    ...
    return e.prototype = {
        ...
        _handleAutoScroll: function (e, t) {
            var n = this, r = (e.touches ? e.touches[0] : e).clientX, i = (e.touches ? e.touches[0] : e).clientY,
...
var sr, cr, lr, ur, dr, fr, pr, mr, hr, gr, B, _r, vr, yr, br, V, H, U, W, G, xr, Sr, K, Cr, wr, q, Tr, Er, Dr, J, Or,
    kr, Ar, jr, Y, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, Br, Vr, X, Hr, Ur, Wr, Gr, Kr, qr, Jr, Yr, Xr, Zr, Qr, $r, ei, ti,
    ni, ri, Z, ii, ai, oi, si, ci, li, ui, di, fi, pi = t((() => {
        sr = "1.15.6", cr = xn(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), lr = xn(/Edge/i), ur = xn(/firefox/i), dr = xn(/safari/i) && !xn(/chrome/i) && !xn(/android/i), fr = xn(/iP(ad|od|hone)/i), pr = xn(/chrome/i) && xn(/android/i), mr = {
            ...
            var n = F(e),
                ...
                i = On(e, 0, t), a = On(e, 1, t), o = i && F(i), s = a && F(a),
                c = o && parseInt(o.marginLeft) + parseInt(o.marginRight) + I(i).width,
                l = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + I(a).width;
            ...
            var r = n ? e.left : e.top, i = n ? e.right : e.bottom, a = n ? e.width : e.height, o = n ? t.left : t.top,
                s = n ? t.right : t.bottom, c = n ? t.width : t.height;
            ...
            _onTapStart: function (e) {
                if (e.cancelable) {
                    var t = this, n = this.el, r = this.options, i = r.preventOnFilter, a = e.type,
            ...
            _onTouchMove: function (e) {
                if (jr) {
                    var t = this.options, n = t.fallbackTolerance, r = t.fallbackOffset, i = e.touches ? e.touches[0] : e,
                        a = W && wn(W, !0), o = W && a && a.a, s = W && a && a.d, c = Kr && X && An(X),
                        l = (i.clientX - jr.clientX + r.x) / (o || 1) + (c ? c[0] - Hr[0] : 0) / (o || 1),
                        u = (i.clientY - jr.clientY + r.y) / (s || 1) + (c ? c[1] - Hr[1] : 0) / (s || 1);
                    if (!z.active && !Or) {
            ...
            _onDragOver: function (e) {
                var t = this.el, n = e.target, r, i, a, o = this.options, s = o.group, c = z.active, l = Dr === s,
                    u = o.sort, d = J || c, f, p = this, m = !1;
                if (Ur) return;
                ...
                if (kr = !1, c && !o.disabled && (l ? u || (a = U !== G) : J === this || (this.lastPutMode = Dr.checkPull(this, c, H, e)) && s.checkPut(this, c, H, e))) {
                    ...
                    if (!y || Yn(e, f, this) && !y.animated) {
                        ...
                        i = I(n);
                        var x = 0, ee, te = H.parentNode !== t,
                            ne = !Zr(H.animated && H.toRect || r, n.animated && n.toRect || i, f), S = f ? "top" : "left",
                            re = Dn(n, "top", "top") || Dn(H, "top", "top"), ie = re ? re.scrollTop : void 0;
            ...
            if (t.scroll) {
                var i = (e.touches ? e.touches[0] : e).clientX, a = (e.touches ? e.touches[0] : e).clientY,
                    o = t.scrollSensitivity, s = t.scrollSpeed, c = En(), l = !1, u;
                ai !== n && (ai = n, rr(), ii = t.scroll, u = t.scrollFn, ii === !0 && (ii = Mn(n, !0)));
                var d = 0, f = ii;
                do {
                    var p = f, m = I(p), h = m.top, g = m.bottom, _ = m.left, v = m.right, y = m.width, b = m.height,
                        x = void 0, ee = void 0, te = p.scrollWidth, ne = p.scrollHeight, S = F(p), re = p.scrollLeft,
                        ie = p.scrollTop;
                    ...
                    var C = x && (Math.abs(v - i) <= o && re + y < te) - (Math.abs(_ - i) <= o && !!re),
                        ae = ee && (Math.abs(g - a) <= o && ie + b < ne) - (Math.abs(h - a) <= o && !!ie);
            ...
            var t = e.originalEvent, n = e.putSortable, r = e.dragEl, i = e.activeSortable, a = e.dispatchSortableEvent,
                o = e.hideGhostForTarget, s = e.unhideGhostForTarget;
            if (t) {
                var c = n || i;
                o();
                var l = t.changedTouches && t.changedTouches.length ? t.changedTouches[0] : t,
        ...
        d(), He(), ve(), hi = .4, gi = class {
            ...
            getIdleWidth(e) {
                let t = e.radioGroup, n = Number.parseFloat(getComputedStyle(document.documentElement).fontSize),
                    r = Number.parseFloat(getComputedStyle(t).getPropertyValue("--copilot-size-md")) * n;
                return n * .125 * 2 + r;
            }
            ...
            constructor(...t) {
                super(...t), this.lastDocumentMouseClientX = 0, this.lastDocumentMouseClientY = 0, this.ticking = !1, this.handlePointerProximity = (e) => {
                    ...
                    let r = this.toolbar.radioGroup, i = r.style.width, a = this.toolbar.getBoundingClientRect(),
                        o = Math.max(a.left - t, 0, t - a.right), s = Math.max(a.top - n, 0, n - a.bottom),
                        c = Math.max(0, 1 - Math.hypot(o, s) / e.PROXIMITY_RADIUS),
                        l = Number.parseFloat(getComputedStyle(r).getPropertyValue("--copilot-toolbar-mode-width")),
                        u = this.getIdleWidth(this.toolbar), d = hi + (1 - hi) * c;
            ...
            constructor(...e) {
                super(...e), this.sortableInitialized = !1, this.modeRadioButtonItems = [], this.devToolsDataLoading = !1, this.devToolsDataLoaded = !1, this.isDragging = !1, this.dragPreparing = !1, this.dragStartX = 0, this.dragStartY = 0, this.toolbarStartRight = 0, this.toolbarStartTop = 0, this.wasDraggedInLastInteraction = !1, this.dragThreshold = 5, this.expandModeHandler = new gi(), this.transitionStart = (e) => {
                    ...
                    if (this.dragPreparing && r > this.dragThreshold && (this.isDragging = !0, this.dragPreparing = !1, this.style.transition = "none"), this.isDragging) {
                        let e = this.toolbarStartRight - t, r = this.toolbarStartTop + n, i = this.getBoundingClientRect(),
                ...
                this.addEventListener("transitionstart", this.transitionStart), this.addEventListener("transitionend", this.transitionEnd), this.addEventListener("mousedown", this.handleMouseDown), this.addEventListener("click", this.handleClick, !0), window.addEventListener("resize", this.handleWindowResize), this.reaction(() => O.userInfo, () => {
                    ...
                    requestAnimationFrame(() => {
                        ...
                        if (this.hasAttribute("modes-expanded")) {
                            ...
                            let t = Number.parseFloat(getComputedStyle(document.documentElement).fontSize),
                                n = Number.parseFloat(getComputedStyle(e).getPropertyValue("--copilot-size-md")) * t;
...
var Fi = t((() => {
  ...
  `, this.tryAcquireLicense = () => {
    ...
    e = t.exports = {};
    var o = e.re = [], s = e.safeRe = [], c = e.src = [], l = e.safeSrc = [], u = e.t = {}, d = 0, f = "[a-zA-Z0-9-]",
        p = [
            ["\\s", 1],
            ["\\d", i],
            [f, r]
    ...
    var n = zi(), {MAX_LENGTH: r, MAX_SAFE_INTEGER: i} = Ri(), {safeRe: a, t: o} = Bi(),
        s = Vi(), {compareIdentifiers: c} = Hi();
    t.exports = class e {
        constructor(t, c) {
    ...
    var r = new (fa())(), i = Vi(), a = pa(), o = zi(), s = Q(), {
            safeRe: c,
            t: l,
            comparatorTrimReplace: u,
            tildeTrimReplace: d,
            caretTrimReplace: f
        } = Bi(), {FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: m} = Ri(), h = (e) => e.value === "<0.0.0-0",
        g = (e) => e.value === "", _ = (e, t) => {
            let n = !0, r = e.slice(), i = r.pop();
            for (; n && r.length;) n = r.every((e) => i.intersects(e, t)), i = r.pop();
            return n;
        },
        v = (e, t) => (e = e.replace(c[l.BUILD], ""), o("comp", e, t), e = ee(e, t), o("caret", e), e = b(e, t), o("tildes", e), e = ne(e, t), o("xrange", e), e = re(e, t), o("stars", e), e),
        y = (e) => !e || e.toLowerCase() === "x" || e === "*",
        b = (e, t) => e.trim().split(/\s+/).map((e) => x(e, t)).join(" "), x = (e, t) => {
        ...
        }, re = (e, t) => (o("replaceStars", e, t), e.trim().replace(c[l.STAR], "")),
        ie = (e, t) => (o("replaceGTE0", e, t), e.trim().replace(c[t.includePrerelease ? l.GTE0PRE : l.GTE0], "")),
        C = (e) => (t, n, r, i, a, o, s, c, l, u, d, f) => (n = y(r) ? "" : y(i) ? `>=${r}.0.0${e ? "-0" : ""}` : y(a) ? `>=${r}.${i}.0${e ? "-0" : ""}` : o ? `>=${n}` : `>=${n}${e ? "-0" : ""}`, c = y(l) ? "" : y(u) ? `<${+l + 1}.0.0-0` : y(d) ? `<${l}.${+u + 1}.0-0` : f ? `<=${l}.${u}.${d}-${f}` : e ? `<${l}.${u}.${+d + 1}-0` : `<=${c}`, `${n} ${c}`.trim()),
        ae = (e, t, n) => {
