...
var T, E, D, O, k, A, j, M, N, P, F = e((() => {
    s(), u(), b(), m(), n(), d(), g(), T = !1, E = 0, D = (e) => {
        ...
        let n = t();
        if (!n) return;
        let r = S(n), a = i(n, "vaadin-dialog") ?? (n.localName === "vaadin-dialog" ? n : null),
            o = a !== null && a.hasAttribute("panel-container"), s = n.localName === "copilot-main",
            u = i(n, "copilot-outline-panel") !== null, d = i(n, "copilot-toolbar") !== null;
