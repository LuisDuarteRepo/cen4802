...
import {$ as t, C as n, et as i, n as a, o, Q as r, r as s, t as c, u as l, y as u} from "./icons-CwakCZgK.js";
import {
    a as d,
    d as f,
    i as p,
...
e((() => {
    ...
    `;
        ...
        renderUserButton() {
            let e = b.userInfo?.validLicense, t = e ? P : F,
                n = e ? "text-amber-12 dark:text-amber-11" : "text-blue-12 dark:text-blue-11",
    ...
    `;
        ...
        renderDevelopmentWorkflow() {
            let e = j(), t = A(), n = this.getDevelopmentWorkflowConfig(e, t), r = n?.bgClass ?? "",
                i = n?.colorClass ?? "", a = this.resolveIcon(n), o = n?.rotateIcon ? `rotate-180 ${i}` : i,
                s = this.resolveTitle(n), c = n?.displayMessage ?? "";
            return l`
      <vaadin-button
